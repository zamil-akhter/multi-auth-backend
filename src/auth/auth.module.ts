...
@Module({
  imports: [MongooseModule.forFeature([{ name: USER_MODEL, schema: UserSchema }]), JwtModule.register({ secret: process.env.JWT_SECRET || 'defaultSecret', signOptions: { expiresIn: '1d' } }), MailModule],
